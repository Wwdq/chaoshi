...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">商品增加</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label >商品名</label>
                            <input type="text" class="form-control" id="name" placeholder="请输入新商品名">
                        </div>
                        <div class="form-group">
                            <label >类别</label>
                            <input type="text" class="form-control" id="type" placeholder="输入类别名">
                        </div>
                        <div class="form-group">
                            <label >价格</label>
                        ...
                        <div class="form-group">
                            <label >优惠价格</label>
                            <input type="text" class="form-control" id="disPrice" placeholder="输入优惠价格">
                        </div>
                        <div class="form-group">
                            <label >数量</label>
