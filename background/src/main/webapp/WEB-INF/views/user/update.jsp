...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">用户维护--用户修改</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label >登陆账号</label>
                            <input type="text" class="form-control" id="username" value="${user.username}"><span id="mySpan"></span>
                        </div>
                        <div class="form-group">
                            <label >确认登录账号</label>
                            <input type="text" class="form-control" id="username1" value="${user.username}"><span id="mySpan1"></span>
                        </div>
                        <div class="form-group">
                            <label  >手机号</label>
                            <input type="text" class="form-control" id="phoneNo" value="${user.telephone}">
...
<script>
    ...
    $("#username1").blur(function () {
        ...
        if(username==username1)
            ...
            $("#mySpan1").html("两次输入的账号不一样 请检查");
    })
    $("#flush").click(function () {
        window.location.href="${PATH}/user/update?id=${user.id}";
    })
    $("#update").click(function () {
        ...
        $.ajax({
            url:"${PATH}/user/doUpdate?id=${user.id}",
            type: "POST",
            data: {
                "username":username,
                "telephone" :phone
