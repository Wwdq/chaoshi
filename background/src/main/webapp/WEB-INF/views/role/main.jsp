        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${PATH}/role/add'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
                    <br>
                    <hr style="clear:both;">
                        ...
                        <table class="table  table-bordered">
                            ...
                            <tr >
                                <td colspan="6" align="center">
                                    <ul class="pagination">
                                        <c:if test="${pageNo>1}">
                                            <li class="disabled"><a href="${PATH}/role/main?pageNo=${pageNo-1}">上一页</a></li>
                                        </c:if>
                                        <c:forEach begin="1" end="${pageMax}" varStatus="now">
                                            ...
                                            <c:if test="${pageNo!=now.count}">
                                                <li ><a href="${PATH}/role/main?pageNo=${now.count}">${now.count}</a></li>
                                            </c:if>
                                        </c:forEach>

                                        <c:if test="${pageNo<pageMax}">
                                            <li><a href="${PATH}/role/main?pageNo=${pageNo+1}">下一页</a></li>
                                        </c:if>
...
<script >
    ...
    function deleteUser(id){
        layer.confirm("确认删除么",  {icon: 3, title:'删除成功'}, function(cindex){
            window.location.href="${PATH}/role/delete?id="+id;
            layer.close(cindex);
        }, function(cindex){
            layer.close(cindex);
        });
