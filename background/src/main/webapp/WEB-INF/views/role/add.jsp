...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">角色维护--角色增加</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label >新的角色名称</label>
                            <input type="text" class="form-control" id="username" placeholder="请输入角色名称"><span id="mySpan"></span>
                        </div>
                        <div class="form-group">
                            <label >确认角色名称</label>
                            <input type="text" class="form-control" id="username1" placeholder="再次输入角色名称"><span id="mySpan1"></span>
                        </div>
                        <div class="form-group">
