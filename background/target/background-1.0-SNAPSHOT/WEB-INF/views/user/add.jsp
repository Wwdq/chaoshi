...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">用户维护--用户增加</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label >登陆账号</label>
                            <input type="text" class="form-control" id="username" placeholder="请输入登陆账号"><span id="mySpan"></span>
                        </div>
                        <div class="form-group">
                            <label >确认登录账号</label>
                            <input type="text" class="form-control" id="username1" placeholder="再次输入登录账号"><span id="mySpan1"></span>
                        </div>
                        <div class="form-group">
                            <label  >手机号</label>
