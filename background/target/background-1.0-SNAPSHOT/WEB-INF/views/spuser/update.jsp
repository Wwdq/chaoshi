...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">用户修改</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form role="form">
                        ...
                        <div class="form-group">
                            <label >用户密码</label>
                            <input type="text" class="form-control" id="password" value="${sp.password}">
                        </div>
                        <div class="form-group">
                            <label >手机号</label>
                            <input type="text" class="form-control" id="phone" value="${sp.phone}">
                        </div>
            ...
            success : function (result) {
                if(result.result){
                    layer.msg("更新成功", {time:1000, icon:5, shift:6}, function () {
                        window.location.href="${PATH}/spuser/main";
                    });
